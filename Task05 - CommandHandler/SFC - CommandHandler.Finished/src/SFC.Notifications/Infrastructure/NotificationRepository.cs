...
{
    class NotificationRepository : IReadWriteNotificationRepository, IReadOnlyNotificationRepository
  {
    ...
    public IEnumerable<NotificationsCountResult> GetSendNotificationsCount(string notificationType, IEnumerable<LoginName> loginNames)
    {
