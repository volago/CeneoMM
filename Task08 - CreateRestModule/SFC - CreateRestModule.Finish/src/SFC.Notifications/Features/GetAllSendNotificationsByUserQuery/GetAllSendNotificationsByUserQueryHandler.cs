...
{
    internal class GetAllSendNotificationsByUserQueryHandler : IQueryHandler<Contract.GetAllSendNotificationsByUserRequest, IEnumerable<NotificationsCountResult>>
  {
    ...
    public IEnumerable<NotificationsCountResult> HandleQuery(Contract.GetAllSendNotificationsByUserRequest query)
    {
